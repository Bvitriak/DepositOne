...
async function loadDeposits() {
  ...
  let response;
  try {
    response = await fetch("/api/deposits" + query, { headers: { Authorization: "Bearer " + token } });
  } catch {
  ...
  page = data.page;
  document.getElementById("depositList").innerHTML = depositList(data);
}

document.getElementById("searchArea").innerHTML = depositSearchBar();
...
const listElement = document.getElementById("depositList");
